        ...
        public IActionResult AddNewRecord()
        {
            ...
            foreach (var i in carts)
            {
                ...
                try
                {
                    con.Open();
                    com.Connection = con;
                    com.CommandText = "insert into OrderDetails (Fullname,phoneNumber,street,districts,city,province,email,payment,product,quantity,total) values('" + fullname + "','" + phoneNumber + "','" + street + "','" + districts + "','" + city + "','" + province + "','" + email + "','" + payment + "','" + product + "','" + quantity + "','" + total + "')";
                    com.ExecuteNonQuery();
                    con.Close();
                }
                catch (Exception ex)
